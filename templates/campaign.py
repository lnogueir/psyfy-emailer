        ...
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            <html xmlns="http://www.w3.org/1999/xhtml"
                ...
                <body style="font-size: 15px;overflow-x:hidden;">
                    <img style="width:250px;" src="{LOGO_RED}"/>
                    <div>
                        <span style="font-size:20px;font-weight:900;">Hello {user_package['full_name']},</span>
                        <p style="padding: 5px 7.5px 7.5px 20px;line-height:26px;">
                            ...
                            &nbsp;&nbsp;1.&nbsp;Go to the following site <a href="https://psycare.ca"><b>psycare.ca</b></a>.<br/>
                        ...
                        <div style="display:flex;">
                            ...
                            <div style="margin-left:15px;margin-top:12.5px;">
